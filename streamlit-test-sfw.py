...
movies = pd.read_csv(r'C:\Users\1\Documents\Data_Science\Recommender_Systems\ml-latest-small\movies.csv')
#movies = pd.read_csv(r'movies.csv')

ratings = pd.read_csv(r'C:\Users\1\Documents\Data_Science\Recommender_Systems\ml-latest-small\ratings.csv')
